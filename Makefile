# This Makefile is for the Peep extension to perl.
#
...
#	NAME => q[Peep]
#	PM => { ../bin/sysmonitor=>q[$(INST_SCRIPT)/sysmonitor], ../bin/keytest=>q[$(INST_SCRIPT)/keytest], ../bin/logparser=>q[$(INST_SCRIPT)/logparser], ../bin/peck=>q[$(INST_SCRIPT)/peck] }
#	PREREQ_PM => {  }
#	VERSION_FROM => q[Peep.pm]
...
TO_INST_PM = ../bin/keytest \
	../bin/logparser \
	../bin/peck \
	../bin/sysmonitor

PM_TO_BLIB = ../bin/sysmonitor \
	$(INST_SCRIPT)/sysmonitor \
	../bin/keytest \
	$(INST_SCRIPT)/keytest \
	../bin/logparser \
	$(INST_SCRIPT)/logparser \
	../bin/peck \
	$(INST_SCRIPT)/peck
...
subdirs ::
	@cd BC && $(MAKE) all $(PASTHRU)


subdirs ::
	@cd Client && $(MAKE) all $(PASTHRU)


subdirs ::
	@cd Conf && $(MAKE) all $(PASTHRU)
...
subdirs ::
	@cd Parse && $(MAKE) all $(PASTHRU)


subdirs ::
	@cd Peck && $(MAKE) all $(PASTHRU)
...
clean ::
	-cd BC && $(TEST_F) Makefile && $(MAKE) clean
	-cd Client && $(TEST_F) Makefile && $(MAKE) clean
	-cd Conf && $(TEST_F) Makefile && $(MAKE) clean
	-cd Log && $(TEST_F) Makefile && $(MAKE) clean
	-cd Parse && $(TEST_F) Makefile && $(MAKE) clean
	-cd Peck && $(TEST_F) Makefile && $(MAKE) clean
...
realclean purge ::  clean
	-cd BC && $(TEST_F) Makefile.old && $(MAKE) -f Makefile.old realclean
	-cd BC && $(TEST_F) Makefile && $(MAKE)  realclean
	-cd Client && $(TEST_F) Makefile.old && $(MAKE) -f Makefile.old realclean
	-cd Client && $(TEST_F) Makefile && $(MAKE)  realclean
	-cd Conf && $(TEST_F) Makefile.old && $(MAKE) -f Makefile.old realclean
	-cd Conf && $(TEST_F) Makefile && $(MAKE)  realclean
	-cd Log && $(TEST_F) Makefile.old && $(MAKE) -f Makefile.old realclean
	-cd Log && $(TEST_F) Makefile && $(MAKE)  realclean
	-cd Parse && $(TEST_F) Makefile.old && $(MAKE) -f Makefile.old realclean
	-cd Parse && $(TEST_F) Makefile && $(MAKE)  realclean
	-cd Peck && $(TEST_F) Makefile.old && $(MAKE) -f Makefile.old realclean
	-cd Peck && $(TEST_F) Makefile && $(MAKE)  realclean
	rm -rf $(INST_AUTODIR) $(INST_ARCHAUTODIR)
	rm -f $(INST_SCRIPT)/sysmonitor $(INST_SCRIPT)/keytest $(INST_SCRIPT)/logparser $(INST_SCRIPT)/peck
...
$(MAKE_APERL_FILE) : $(FIRST_MAKEFILE)
	...
	@$(PERL) -I$(INST_ARCHLIB) -I$(INST_LIB) -I$(PERL_ARCHLIB) -I$(PERL_LIB) \
		Makefile.PL DIR=BC:Client:Conf:Log:Parse:Peck \
...
test :: $(TEST_TYPE)
	@cd BC && $(TEST_F) Makefile && $(MAKE) test $(PASTHRU)
	@cd Client && $(TEST_F) Makefile && $(MAKE) test $(PASTHRU)
	@cd Conf && $(TEST_F) Makefile && $(MAKE) test $(PASTHRU)
	@cd Log && $(TEST_F) Makefile && $(MAKE) test $(PASTHRU)
	@cd Parse && $(TEST_F) Makefile && $(MAKE) test $(PASTHRU)
	@cd Peck && $(TEST_F) Makefile && $(MAKE) test $(PASTHRU)
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Peep\" VERSION=\"0,4,0,0\">\n}. qq{\t<TITLE>Peep</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Peep.ppd
